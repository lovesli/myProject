...
train_data, test_data = cv.train_test_split(ratings_df, test_size=0.2, random_state=0)
...
als_train_data, als_test_data = cv.train_test_split(ratings, test_size=0.2, random_state=0)
